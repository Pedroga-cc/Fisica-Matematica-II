...
\usepackage[top=2cm,bottom=1.5cm, inner=1.5cm, outer=4cm,includeheadfoot, headheight=16pt]{geometry}
...
%   ]
%       \fill[left!70] (current page.south west) rectangle (current page.north east);
%       \node[mynode] at ($(current page.north east)+(-1,-6)$) {\fontsize{25}{30}\selectfont \textbf{Apuntes de Física Matemática II}};
%       \node[mynode] at ($(current page.north east)+(-1.5,-8)$) {\fontsize{20}{24}\selectfont \textsc{Pedro A. Contreras-Corral}};
...
\begin{tikzpicture}[remember picture,overlay,mynode/.style={left,fill=yellow!10,general shadow={shadow scale=1, shadow xshift=-0.8ex, shadow yshift=-0.8ex,
    opacity=1, fill=gray!50}},]
