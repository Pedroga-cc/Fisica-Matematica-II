...
\begin{ejemplo}
    \textbf{(Arfken 7$^{\boldsymbol{\circ}}$ Edición, Ejemplo 14.7.1)} Considere una partícula cuántica libre de masa $m$ y con energía $E$. Encuentre el valor mínimo de energía para el cual la función de onda del sistema tiene una solución física.

    \textbf{Solución.} Esta situación puede ser descrita mediante la ecuación de Schrödinger,
    \begin{equation*}
        - \frac{\hbar^2}{2m} \nabla^2 \psi = E\psi \ .
    \end{equation*}
